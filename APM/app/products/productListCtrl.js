    ...
    (function (productList) {
        var ProductListController = /** @class */ (function () {
            function ProductListController() {
                ...
                var newProduct = new app.domain.Product(1, 'saw', 'X50', new Date(), 500, 'Show any description', 'http://openclipart.org/image/300px/svg_to_png/26215/Anonymous_Leaf_Rake.png');
